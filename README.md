...
Live Product: next-move-wheat.vercel.app
...
Overview — Primary cluster, stream recommendation, advisory statement, financial note
Clusters — All 8 clusters ranked with scores
Exams — JEE, NEET, UPSC, GATE readiness scores with status
Plan — 3 concrete actions to take starting now, gap diagnosis
The Engine — CIE V6
22 Traits Measured
Category	Traits
...
✅ Phase 1 — Engine (Complete)
 CIE V6 engine with 22 traits
 8 career cluster scoring with penalty logic
 4 exam readiness scores
 Stream recommendation
 Alignment detection
 Hard Truth advisory mode
 Action plan generator
 Financial feasibility warning
 Mobile-optimized UI
 Deployed on Vercel
